...
//        System.currentTimeMillis()
    ...
    public void getFiles(@PathVariable String flag, HttpServletResponse response) {
        ...
        String basePath = System.getProperty("user.dir") + "/springboot/src/main/resources/files/"; // 定义文件上传根路径
        List<String> fileNames = FileUtil.listFileNames(basePath); //获取所有的文件名字
        String fileName = fileNames.stream().filter(name -> name.contains(flag)).findAny().orElse(""); //找到跟参数对应的文件
        try {
